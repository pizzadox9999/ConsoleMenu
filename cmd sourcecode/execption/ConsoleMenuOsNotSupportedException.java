...
/** define custom exception class which extends RuntimeException*/
public class ConsoleMenuOsNotSupportedException extends RuntimeException{
  /** @param errorMessage takes custom errormessage*/
  public ConsoleMenuOsNotSupportedException(String errorMessage) {
    super(errorMessage);
  }
}
